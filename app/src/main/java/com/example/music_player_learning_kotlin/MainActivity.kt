...
import com.example.music_player_learning_kotlin.R
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title_txt.text = ""+ resources.getResourceEntryName(R.raw.thoda_thoda)
